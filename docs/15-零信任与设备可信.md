...
- EDR 风险。
- 密码泄露信号。风险信号只能作为决策输入，不能单一因素决定全部访问。
...
- NIST SP 800-207 零信任 Architecture
- NIST SP 800-207A Cloud-Native 零信任
- Microsoft 零信任 / SDL 实践

## 35. 变更记录

| 版本 | 日期 | 说明 |
|---|---|---|
| V0.1 | 2026-09 | 建立 零信任 与设备可信框架 |
...
- **前置知识**：[[docs/02-资产与网络架构|02 资产与网络架构]] · [[docs/04-身份与访问控制|04 身份与访问控制]] · [[docs/05-终端与服务器安全|05 终端与服务器安全]]
- **下游知识**：无
- **横向关联**：[[docs/03-网络与边界安全|03 网络与边界安全]] · [[docs/16-云与工作负载安全|16 云与工作负载安全]] · [[docs/21-密码学PKI-KMS与凭据治理|21 密码学、PKI、KMS 与凭据治理]]
