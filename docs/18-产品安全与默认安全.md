...
- **前置知识**：[[docs/06-应用与API安全|06 应用与 API 安全]] · [[docs/08-DevSecOps与软件供应链安全|08 DevSecOps 与供应链安全]] · [[docs/17-安全架构评审与威胁建模|17 安全架构评审与 Threat Modeling]]
- **下游知识**：[[docs/20-PSIRT与漏洞披露|20 PSIRT 与漏洞披露]]
- **横向关联**：[[docs/22-安全工程平台|22 Security Engineering Platform]] · [[docs/23-AI大模型与智能体安全|23 AI、LLM 与 Agent 安全]] · [[docs/24-移动应用安全|24 移动应用安全]]
