...
~~~text
path:docs -path:docs/templates -path:docs/08-devsecops/reference-full-v1 -path:docs/09-vulnerability/reference-full-v1
~~~
...
[[docs/08-devsecops-and-supply-chain|08 DevSecOps 与供应链安全]]
...
3. 更新 [[docs/knowledge-map|公司安全知识图谱]]。
4. 执行：
