...
1. [Security Control Catalog](安全控制目录.md)：统一 Control ID、Owner、Evidence、Frequency、Metric 和 Exception。
2. [Current / Target Profile](安全现状与目标画像.md)：区分“当前真实做到什么”和“目标做到什么”。
3. [Security RACI](安全职责RACI.md)：明确 Responsible、Accountable、Consulted、Informed。
