...
回答谁在什么时候按什么步骤做。例如 严重漏洞处置 SOP、离职权限回收 SOP、Certificate Rotation SOP。

## 5. 处置手册

面向特定事件，例如 Ransomware、凭据 Leak、Account Compromise。重点是快速动作，不重复完整政策。
...
正式文档 SHOULD 逐步增加 Document ID、Type、负责人、Approver、版本、Effective Date、评审 Cycle、Related Controls。

## 10. 去重原则

1. 控制目录 保留唯一正式 Requirement。
...
### 08 DevSecOps
拆为 Git & Source、Jenkins & Builder、Dependency/SCA、SAST/凭据/SBOM、Container/IaC/Artifact、安全门禁 & 例外、Trusted Build/SLSA。

### 09 Vulnerability
拆为 Vulnerability Management、风险 Rating & SLA、Remediation & 例外、Penetration Testing、Reporting & Metrics、Operations Checklist。
